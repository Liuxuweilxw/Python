...
import re
#自己修改url文件路径
urltxt = open('C:/Users/liuxuwei/OneDrive/ME/python/database/url/fz1.txt', 'r', encoding='UTF-8')
...
for url in urlList:
    ...
    path='C:/Users/liuxuwei/OneDrive/ME/python/database/fz1/out/'+str(i)+'.txt'
    print(i)
    i+=1
