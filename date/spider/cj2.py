...
import re
#自己修改url文件路径
urltxt = open('C:/Users/liuxuwei/OneDrive/ME/python/database/url/cj2.txt', 'r', encoding='UTF-8')
...
for url in urlList:
    ...
    path='C:/Users/liuxuwei/OneDrive/ME/python/database/cj2/out/'+str(i)+'.txt'
    print(i)
    i+=1
